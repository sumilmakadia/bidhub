...
<body class="skin-default card-no-border">
        ...
        <div class="login-register" style="background-image:url(../assets/images/background/login-register.jpg); padding-top:5%;">
            <div class="login-box card">
                <div class="card-body pt-50">
                    <form id="reg-form" class="form-horizontal form-material" role="form" method="post" action="<?php echo e(route('register')); ?>">
                        ...
                        <?php if($errors->any()): ?>
                            <div class="alert alert-danger">
                                    <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <p style="margin:0;text-align: center;"><?php echo e($error); ?></p>
   ...
   data-target="#favoritesModal">Terms & Conditions</a></label>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="subscribeuser_chk" id="subscribeuser_chk">
                                    <label class="custom-control-label" for="subscribeuser_chk">Subscribe to Email update</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                Do you want to know how it works? <a href="<?php echo e(url('/how-it-work')); ?>" class="text-info m-l-5"><b>Click here</b></a>
                            </div>
                        </div>
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
...
<?php /**PATH /home/bidhub/bidhub/resources/views/pages/auth/auth_register.blade.php ENDPATH**/ ?>