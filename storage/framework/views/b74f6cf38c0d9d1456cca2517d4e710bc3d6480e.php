										...
										<tr>
											<td valign="top" id="body_content" style="background-color: #ffffff;">
												...
												<table border="0" cellpadding="20" cellspacing="0" width="100%" style="font-family:raleway; font-size:20px;">
													<tr>
														<td style="text-align:center;font-weight: regular;color:#000;font-family:raleway;">Review Proposal for: <span style="color:black;font-weight: bold;">"<?php echo e($proposal->project->title); ?>"</span></td>
                                                    </tr>  
                                                </table>
												<table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_body" style="font-family:raleway; font-size:20px; margin-left:30px;margin-top:35px;">
                                                    <tr>
														...
														<td style="padding-left: 8px; width:1px;"><img src="<?php echo e(asset('') . $proposal->user->avatar); ?>" width="60" height="60" alt="No User Picture" style="border: 1px solid #edf1f5;"></td>
                                                        <td style="padding-left: 8px; text-align:left;font-weight: bold;color:#000;font-family:raleway;" valign="top"><?php echo e($proposal->profile->first_name); ?> <?php echo e($proposal->profile->last_name); ?><br><span style="padding-top:10px"><?php echo e($proposal->profile->company); ?></span></td>
													</tr>
												</table>
												<table border="0" cellpadding="0" cellspacing="0" width="580" id="template_body" style="font-family:raleway; font-size:20px; margin-top:70px; margin-left:30px;">
                                                    <tr>
														<td style="width:580px;color:#000;font-family:raleway;">Description: <?php echo e($proposal->bid_description); ?></td>
													</tr>
												</table>
												<table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_body" style="font-family:raleway; font-size:20px; margin-top:20px; margin-left:30px;">
                                                    <tr>
														<td style="width:100%;color:#000;font-family:raleway;">Trade: <?php echo e($proposal->profile->trade); ?></td>
													</tr>
												</table>
...
</html><?php /**PATH /home/bidhub/bidhub/resources/views/emails/proposal.blade.php ENDPATH**/ ?>