		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor"><?php echo e(!empty($project->title) ? $project->title : 'Project'); ?></h4>
				</div>
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						<a href="<?php echo e(route('project-room.project.index')); ?>" class="btn btn-info m-l-15 float-right" title="<?php echo e(trans('projects.show_all')); ?>">
							...
							<?php echo e(trans('projects.show_all')); ?>
				...
				<div class="col-md-8 mx-auto">
					<div class="card">
						<div class="card-body">
							...
							<form method="POST" autocomplete="off" action="<?php echo e(route('project-room.project.update', $project->id)); ?>" id="edit_project_form" name="edit_project_form" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
								...
								<div class="form-group">
									<div class="col-md-offset-2 col-md-12">
										<input class="btn btn-info d-lg-block m-l-15" type="submit" style="width: 100%;margin-top: 30px;" value="<?php echo e(trans('projects.update')); ?>">
									</div>
								</div>
							</form>
						</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bidhub/bidhub/resources/views/project-room/edit.blade.php ENDPATH**/ ?>