		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor">Property For Sale</h4>
				</div>
				...
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						<a href="<?php echo e(route('property-for-sale.property.create')); ?>" class="btn btn-info m-l-15" title="<?php echo e(trans('helps.index')); ?>">
							Create Property
						</a>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-12">
					<?php echo $__env->make('property-for-sale/search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				</div>
			</div>
						...
						<div class="col-lg-3 col-md-6">
							<div class="card">
								<div class="card-image mh-200">
									<a href="<?php echo e(route('property-for-sale.property.show', $property->id )); ?>">
										<img class="card-img-top img-responsive" src="<?php echo e(asset($property->property_image)); ?>" alt=" image cap">
									</a>
								</div>
								<div class="card-body">
									<div class="row mb-20">
										<div class="col">
											...
											<h5 class="font-light"><?php echo e($property->property_acres); ?></h5>
										</div>
										<div class="col">
											<h3 class="m-b-0"></h3>
										...
										<div class="col">
											<h3 class="m-b-0">Cost</h3>
											<h5 class="font-light"><?php echo e(money_format('%.2n', $property->property_cost)); ?></h5>
										</div>
									</div>
									...
									<p><?php echo e(str_limit($property->property_description,150)); ?></p>
									<p class="m-b-0 m-t-10"><?php echo e($property->location); ?></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bidhub/bidhub/resources/views/property-for-sale/public.blade.php ENDPATH**/ ?>