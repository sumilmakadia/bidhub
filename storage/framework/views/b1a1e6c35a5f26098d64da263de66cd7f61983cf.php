	...
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor"><?php echo e(trans('helps.create')); ?></h4>
			</div>
			<div class="col-md-7 align-self-center text-right">
				<div class="d-flex justify-content-end align-items-center">
				  <a href="<?php echo e(route('help-wanted.help.index')); ?>" class="btn btn-info m-l-15 float-right" title="<?php echo e(trans('helps.show_all')); ?>">
                                          <i class="fa fa-plus-circle"></i> Show All Help Wanted
                                 </a>
                                 	</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-8 mx-auto">
			 ...
			 <?php if($errors->any()): ?>
                        ...
                        <form method="POST" action="<?php echo e(route('help-wanted.help.store')); ?>" accept-charset="UTF-8" id="create_help_form" name="create_help_form" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <?php echo $__env->make('help-wanted.form', [
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-10">
                                    <input class="btn btn-info d-lg-block m-l-15" type="submit" value="Submit" style="width:100%;">
                                </div>
                            </div>
...
//         },
	...
	<script>
              ...
              $(document).on('ready', function() {
                ...
                $('#create_help_form').submit(function() {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bidhub/bidhub/resources/views/help-wanted/create.blade.php ENDPATH**/ ?>