            ...
            <div class="row mt-3">
                ...
                <p>Local advertisers can advertise in our Directory to gain exposure to the homeowners, Contractors and other merchants that help their businesses </p>
                 <p>Everyone has the ability to purchase ads to be posted in our Help Wanted section by signing up for the low fees offered based on the amount of ads they need to post.</p>
                    ...
                    <div class="text-center" style="padding: 20px 0px;"><a href="<?php echo e(url('/register')); ?>" class="btn btn-primary">Register Now</a></div>
...
<?php echo $__env->make('themes.ino.app_ino', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bidhub/bidhub/resources/views/pages/guest/how_it_work.blade.php ENDPATH**/ ?>