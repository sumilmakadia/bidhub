...
<div class="row form-row">
    ...
    <div class="col-12">
        <div class="form-group <?php echo e($errors->has('property_title') ? 'has-error' : ''); ?>">
            <label for="property_title" class="required">Property for Sale Title</label>
            <div class="">
                <input class="form-control" name="property_title" type="text" id="property_title" value="<?php echo e(old('property_title', optional($property)->property_title)); ?>" maxlength="100" placeholder="<?php echo e(trans('properties.property_title__placeholder')); ?>" required>
                <?php echo $errors->first('property_title', '<p class="help-block">:message</p>'); ?>

            </div>
        </div>
    </div>
    <div class="col-12">
        <div class="form-group <?php echo e($errors->has('property_description') ? 'has-error' : ''); ?>">
            <label for="property_description" class="required">Description</label>
            <div class="">
                <textarea class="form-control" name="property_description" cols="50" rows="10" id="property_description" placeholder="Description" required><?php echo e(old('property_description', optional($property)->property_description)); ?></textarea>
                <?php echo $errors->first('property_description', '<p class="help-block">:message</p>'); ?>
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<input class="form-control" name="phone" type="tel" value="<?php echo e(old('phone', optional($property)->phone)); ?>">
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			<label for="phone" class="required">Email</label>
			<input require class="form-control required" name="email" type="email" value="<?php echo e(old('email', optional($property)->email)); ?>">
		</div>
	</div>
...
<div class="col-12">
    ...
    <div class="col-md-6">
        <div class="form-group <?php echo e($errors->has('property_cost') ? 'has-error' : ''); ?>">
            <label for="property_cost" class="required">What is your listing price? </label>
            <div class="">
                <input class="form-control" name="property_cost" type="number" min="0" step="any" id="property_cost" value="<?php echo e(old('property_cost', optional($property)->property_cost)); ?>" placeholder=" What is your listing price? " required>
                <?php echo $errors->first('property_cost', '<p class="help-block">:message</p>'); ?>
    ...
    <div class="col-md-6">
        <div class="form-group <?php echo e($errors->has('property_acres') ? 'has-error' : ''); ?>">
            <label for="property_acres" class="required"> How many acres of Property?</label>
            <div class="">
                <input class="form-control" name="property_acres" type="number" min="0" step="any" id="property_acres" value="<?php echo e(old('property_acres', optional($property)->property_acres)); ?>" maxlength="100" placeholder="How Many Acres" required>
                <?php echo $errors->first('property_acres', '<p class="help-block">:message</p>'); ?>
    ...
    <div class="col-md-6">
        <div class="form-group <?php echo e($errors->has('parcel_tax_number') ? 'has-error' : ''); ?>">
            ...
            <div class="">
                <input class="form-control" name="parcel_tax_number" type="text" id="parcel_tax_number" value="<?php echo e(old('parcel_tax_number', optional($property)->parcel_tax_number)); ?>" placeholder="Parcel / Tax ID" required>
    ...
    <div class="col-md-6">
        <div class="form-group <?php echo e($errors->has('property_annual_taxes') ? 'has-error' : ''); ?>">
            <label for="property_annual_taxes" class="required"> Annual Tax </label>
            <div class="">
                <input class="form-control" name="property_annual_taxes" type="text" id="property_annual_taxes" value="<?php echo e(old('property_annual_taxes', optional($property)->property_annual_taxes)); ?>" placeholder="Annual Taxes" required>
                <?php echo $errors->first('property_annual_taxes', '<p class="help-block">:message</p>'); ?>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="">
                <input class="form-control" name="location" type="text" id="location" value="<?php echo e(old('location', optional($property)->location)); ?>" maxlength="255" placeholder="Enter Location">
            </div>
        </div>
    </div>
    ...
    <div class="col-12" style="padding-left:0;">
                ...
                <div class="col-md-12" style="margin-bottom:20px;">
                    <div class="d-flex align-items-center">
                        <a href="/pricing" class="btn btn-info m-l-15" title="<?php echo e(trans('properties.create')); ?>" style="margin-left:0;">
...
<?php /**PATH /home/bidhub/bidhub/resources/views/property-for-sale/form.blade.php ENDPATH**/ ?>