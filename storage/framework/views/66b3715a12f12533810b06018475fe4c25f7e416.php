		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor"><?php echo e(!empty($title) ? $title : 'Equipment'); ?></h4>
				</div>
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						<a href="<?php echo e(route('equipment-for-sale.property.index')); ?>" class="btn btn-info m-l-15 float-right" title="<?php echo e(trans('equipments.show_all')); ?>">
							...
							<?php echo e(trans('equipments.show_all')); ?>
				...
				<div class="col-md-8 mx-auto">
					<div class="card">
						<div class="card-body">
							...
							<form method="POST" autocomplete="off" action="<?php echo e(route('equipment-for-sale.property.update', $equipment->id)); ?>" id="edit_property_form" name="edit_property_form" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
								...
								<div class="form-group">
									<div class="col-md-12">
										<input class="btn btn-info d-lg-block m-l-15" style="width: 100%;margin-top: 30px;" type="submit" value="<?php echo e(trans('equipments.update')); ?>">
									</div>
								</div>
							</form>
						</div>
...
<?php $__env->startSection('js'); ?>
	...
	<script>
              ...
              $('#edit_property_form').submit(function() {
...
//         },
    ...
    $( '.delete-file' ).click(function(e) {
		    ...
		    $('#'+id).hide();
				$.ajax({
					type: 'post',
					url: '/equipment-for-sale/remove-file',
					data: {
		...
		$( '.delete-galery' ).click(function(e) {
		    ...
		    $('#'+id).hide();
				$.ajax({
					type: 'post',
					url: '/equipment-for-sale/remove-galery',
					data: {
					    '_token': $('meta[name="csrf-token"]').attr('content'),
					    'id': $(this).data( "id" ),
					},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bidhub/bidhub/resources/views/equipment-for-sale/edit.blade.php ENDPATH**/ ?>