		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor"><?php echo e(trans('projects.create')); ?></h4>
				</div>
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						<a href="<?php echo e(route('project-room.project.index')); ?>" class="btn btn-info m-l-15 float-right" title="<?php echo e(trans('projects.show_all')); ?>">
							<i class="fa fa-plus-circle"></i> <?php echo e(trans('projects.show_all')); ?>
				...
				<div class="col-md-8 mx-auto">
					...
					<div class="card">
						<div class="card-body">
							...
							<form method="POST" autocomplete="off" action="<?php echo e(route('project-room.project.store')); ?>" accept-charset="UTF-8" id="create_project_form" name="create_project_form" class="form-horizontal" enctype="multipart/form-data">
								<?php echo e(csrf_field()); ?>

								<?php echo $__env->make('project-room.form', [
										        'project' => null,
										      ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

								<div class="form-group">
									<div class="col-md-120">
										<button class="btn btn-info d-lg-block m-l-15" style="width:100%;margin-top:20px;" type="submit" value="<?php echo e(trans('projects.add')); ?>">Submit</button>
									</div>
								</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bidhub/bidhub/resources/views/project-room/create.blade.php ENDPATH**/ ?>