	...
	<div class="container m-t-20" style="margin-bottom: 50px">
		<div class="card mx-auto col-12">
			<div class="card-body">
				...
				<form id="my-awesome-dropzone" method="POST" action="<?php echo e(route('profiles.profile.update', $profile->id)); ?>" enctype="multipart/form-data">
					<?php echo e(csrf_field()); ?>

					<?php echo $__env->make('profiles.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('js'); ?>
	...
	<link href="<?php echo e($assets_path); ?>js/editor/jquery-te-1.4.0.css" media="all" rel="stylesheet">
    <script src="<?php echo e($assets_path); ?>js/editor/jquery-te-1.4.0.min.js"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bidhub/bidhub/resources/views/profiles/edit.blade.php ENDPATH**/ ?>