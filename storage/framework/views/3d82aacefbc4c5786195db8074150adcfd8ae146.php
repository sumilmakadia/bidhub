	...
	<div class="container m-t-20" style="margin-bottom: 50px">
		<div class="card mx-auto col-10">
			<div class="card-body">
				...
				<form method="POST" id="create_new_profile" action="<?php echo e(route('profiles.profile.store')); ?>" enctype="multipart/form-data">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bidhub/bidhub/resources/views/profiles/create.blade.php ENDPATH**/ ?>