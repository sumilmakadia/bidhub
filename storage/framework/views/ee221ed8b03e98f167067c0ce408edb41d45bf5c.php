...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<title><?php echo e(config('app.name', 'application-name=BidHub')); ?></title>
	
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="">
	<!-- Favicon icon -->
	<link rel="icon" type="image/png" sizes="16x16" href="<?php echo e($assets_path_public_eli); ?>images/favicon.png"><!-- This page CSS -->
    ...
    <link rel="stylesheet" href="<?php echo e($assets_path); ?>js/Owl/dist/assets/owl.carousel.min.css">
    <link rel="stylesheet" href="<?php echo e($assets_path); ?>js/Owl/dist/assets/owl.theme.default.min.css">
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.css">
	<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css">
	<link rel="stylesheet" href="<?php echo e($assets_path); ?>js/prettyphoto/css/prettyPhoto.css" type="text/css" media="screen" charset="utf-8" />
	<!-- chartist CSS -->
	<link href="<?php echo e($assets_path_public_eli); ?>node_modules/morrisjs/morris.css" rel="stylesheet">
	<!--Toaster Popup message CSS -->
	<link href="<?php echo e($assets_path_public_eli); ?>node_modules/toast-master/css/jquery.toast.css" rel="stylesheet">
	<link href="<?php echo e($assets_path_public_eli); ?>node_modules/calendar/dist/fullcalendar.css" rel="stylesheet"/>
	<!-- Custom CSS -->
	<link href="<?php echo e($assets_path_public_eli); ?>dist/css/style.min.css" rel="stylesheet">
	<link href="<?php echo e(asset('css/style.css')); ?>" rel="stylesheet">
	<!-- Dashboard 1 Page CSS -->
	<link href="<?php echo e($assets_path_public_eli); ?>dist/css/pages/dashboard1.css" rel="stylesheet">
	...
	<![endif]-->
	<link href="<?php echo e($assets_path_public_eli); ?>dist/css/pages/pricing-page.css" rel="stylesheet">


		  <?php if (Request::is('messages')): ?>
	<link href="<?php echo e($assets_path_public_eli); ?>dist/css/style.min.css" rel="stylesheet">
	<!-- page css -->
	<link href="<?php echo e($assets_path_public_eli); ?>dist/css/pages/inbox.css" rel="stylesheet">
		  <?php endif; ?>
    ...
    <!-- Popup CSS -->
	<link href="<?php echo e($assets_path_public_eli); ?>node_modules/Magnific-Popup-master/dist/magnific-popup.css" rel="stylesheet">
	<!-- Custom CSS -->
	<link href="<?php echo e($assets_path_public_eli); ?>dist/css/style.min.css" rel="stylesheet">
	<!-- page css -->
	<link href="<?php echo e($assets_path_public_eli); ?>dist/css/pages/user-card.css" rel="stylesheet">
		  <?php endif; ?>
	<?php if(Request::is('chat-rooms')): ?>
	<link href="<?php echo e($assets_path_public_eli); ?>dist/css/pages/chat-app-page.css" rel="stylesheet">
	<?php endif ?>
	...
	<!-- fileuploader -->
	<!-- font -->
    <link href="<?php echo e($assets_path); ?>assets/fileuploader/dist/font/font-fileuploader.css" media="all" rel="stylesheet">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.2/css/all.css" integrity="sha384-oS3vJWv+0UjzBfQzYUhtDYW+Pj2yciDJxpsK1OYPAYjqT085Qq/1cq5FLXAZQ7Ay" crossorigin="anonymous">
    
    <!-- css -->
    <link href="<?php echo e($assets_path); ?>assets/fileuploader/dist/jquery.fileuploader.min.css" media="all" rel="stylesheet">
    <link href="<?php echo e($assets_path); ?>assets/fileuploader/examples/thumbnails/css/jquery.fileuploader-theme-thumbnails.css" media="all" rel="stylesheet">
    <link href="<?php echo e($assets_path); ?>css/custom.css" media="all" rel="stylesheet">
...
<body class="skin-blue fix-header single-column  card-no-border ">
	<div class="preloader1">
		<div class="loader">
			...
			<p class="loader__label"><?php echo $__env->yieldContent('title'); ?></p>
		</div>
	</div>
<div id="main-wrapper">
                            <?php
	...
	<!--</div>    				        -->
    <div class="nav-item" style="background-color:#000;">
         <?php if(Session::has('roommessage')): ?>
        <a href="#." class="nav-link d-none d-lg-block d-md-block waves-effect waves-dark" style="padding: 8px 10px 5px;line-height: 16px;color:#fff;text-align:center;"><?php echo e(Session::get('roommessage')); ?></a>
            <?php endif; ?>  
								...
								<?php if(isset($plan->plan_name)): ?><?php if(isset($difference)): ?><a href="/pricing" class="nav-link d-none d-lg-block d-md-block waves-effect waves-dark" style="padding: 8px 10px 5px;line-height: 16px;color:#fff;text-align:center;">PREMIUM - <?php echo e($days_left); ?> Trial Days Left - <?php echo e($message); ?> </a><?php endif; ?> <?php endif; ?>
	                            <?php endif; ?>
	                            <?php endif; ?>
	                            <?php endif; ?>
	</div>
		<header class="topbar">
			...
			<img src="<?php echo e($assets_path_public_eli); ?>images/bidhub.png" alt="homepage" class="dark-logo" style="max-width:none;">
							<!-- Light Logo text -->
			<img src="<?php echo e($assets_path_public_eli); ?>images/bidhub.png" class="light-logo" alt="homepage"></span> </a>
				</div>
				<!-- ============================================================== -->
				<!-- End Logo -->
				<!-- ============================================================== -->
				<div class="navbar-collapse">
					...
					<!-- ============================================================== -->
					<ul class="navbar-nav mr-auto" <?php if(Auth::check() == false): ?> style="width:100%;" <?php endif; ?>>
						...
						<?php if(Auth::check()): ?>
							<?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li class=" nav-item dropdown">
								    ...
								    <?php if($menu['title'] == 'Directory'): ?>
									 <a href="<?php echo e($menu['url']); ?>" target="" style="" data-toggle="dropdown" class="dropdown-toggle nav-link d-none d-lg-block d-md-block waves-effect waves-dark">
										<span><?php echo e($menu['title']); ?> <span class="fa fa-caret-down"></span></span> 
									</a> 
                                        
                                        <ul class="dropdown-menu">
                                          <li><a href="<?php echo e(url('/directory/search?trade=&account_type=Subcontractor&distance=100&page=1')); ?>" class="selcusvvv" data-id="Subcontractor" style="padding:7px 10px; display: block;">Subcontractor</a></li>
                                          <li><a href="<?php echo e(url('/directory/search?trade=&account_type=General Contractor&distance=100&page=1')); ?>" class="selcusvvv" data-id="General Contractor" style="padding:7px 10px; display: block;">General Contractor</a></li>
                                          <!--<li><a href="<?php echo e(url('/directory/search?trade=&account_type=Homeowner&distance=100&page=1')); ?>" class="selcusvvvv" data-id="Homeowner" style="padding:7px 10px; display: block;">Homeowner</a></li>-->
                                          <li><a href="<?php echo e(url('/directory/search?trade=&account_type=Advertiser&distance=100&page=1')); ?>" class="" data-id="Advertiser" style="padding:7px 10px; display: block;">Advertiser</a></li>
                                          <li><a href="<?php echo e(url('/directory/search?trade=Educational Services&account_type=&distance=100&page=1')); ?>" style="padding:7px 10px; display: block;">Educational</a></li>
                                          <li><a href="<?php echo e(url('/directory/search?trade=Cellulose Manufacturer&account_type=&distance=100&page=1')); ?>" style="padding:7px 10px; display: block;">Manufacturer</a></li>
                                          <li><a href="<?php echo e(url('/directory/search?trade=Supplier&account_type=&distance=100&page=1')); ?>" style="padding:7px 10px; display: block;">Supplier</a></li>
                                          <li><a href="<?php echo e(url('/directory/search?trade=Estimating Tools- Software&account_type=&distance=100&page=1')); ?>" style="padding:7px 10px; display: block;">Estimating</a></li>
                                        </ul>
                                     <?php else: ?>
                                     <a href="<?php echo e($menu['url']); ?>" target="" style="" class="nav-link d-none d-lg-block d-md-block waves-effect waves-dark">
					...
					<ul class="navbar-nav my-lg-0">
					  ...
					  <!--      <li class="nav-item">-->
							<!--	<?php if(isset($plan->plan_name)): ?><?php if(isset($difference)): ?><a href="/pricing" class="nav-link d-none d-lg-block d-md-block waves-effect waves-dark" style="border: 2px solid #fff;padding: 8px 10px 5px;line-height: 16px;margin-top: 18px;"><?php echo e($plan->plan_name); ?> <?php echo e(floor($difference / 86400)); ?> trial Days Left </a><?php endif; ?> <?php endif; ?>-->
							<!--</li>-->
						<?php if(Auth::check()): ?>
							...
							<li class="nav-item dropdown messages">
                                <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="ti-email"></i>
                                    <div class="notify"> <?php if($message_count > 0): ?><span class="heartbit"></span> <span class="point"></span> <?php endif; ?> </div>
                                </a>
									...
									<ul>
										...
										<li>
											<div class="message-center ps ps--theme_default" data-ps-id="8bcf39be-39a4-5083-c8df-6c64f12efa30">
												...
												<?php if(isset($message->profile->first_name)): ?>
												<a href="/chat-rooms/<?php echo e($message->chatroom_id); ?>">
													<div class="btn btn-danger btn-circle"><i class="fa fa-paper-plane"></i></div>
													<div class="mail-contnet">
													    
														<h5><?php echo e($message->profile->first_name . ' ' . $message->profile->last_name); ?></h5> <span class="mail-desc"><?php echo e(str_replace("<br>"," ",$message->message)); ?></span> <span class="time"><?php echo e($message->created_at); ?></span></div>
							...
							<li class="nav-item dropdown notifications">
								<a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="ti-bell"></i>
									<div class="notify"><?php if($proposal_count > 0 || $resume_count > 0): ?><span class="heartbit">1</span> <span class="point"></span> <?php endif; ?></div>
								</a>
								<div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown">
									<ul>
										<li>
										...
										<li>
											<div class="message-center ps ps--theme_default" data-ps-id="8bcf39be-39a4-5083-c8df-6c64f12efa30">
												...
												<a href="/project-room/show/<?php echo e($proposal->proposal->project->id); ?>">
													<div class="btn btn-danger btn-circle"><i class="fa fa-paper-plane"></i></div>
													<div class="mail-contnet">
														<h5>New Proposal</h5> <span class="mail-desc"><?php echo e(str_replace('<br>'," ",$proposal->message)); ?></span> <span class="time"><?php echo e($proposal->created_at); ?></span></div>
												</a>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												...
												<?php if(isset($resume->resume->help->id)): ?>
												<a href="/help-wanted/show/<?php echo e($resume->resume->help->id); ?>">
													<div class="btn btn-danger btn-circle"><i class="fa fa-paper-plane"></i></div>
													<div class="mail-contnet">
														<h5>New Resume</h5> <span class="mail-desc"><?php echo e(str_replace('<br>'," ",$resume->message)); ?></span> <span class="time"><?php echo e($resume->created_at); ?></span></div>
												</a>
												<?php endif; ?>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												<!--<a href="javascript:void(0)">-->
							...
							<li class="nav-item dropdown u-pro">
								<a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo e(Auth::user()->avatar); ?>" alt="user" class=""> <span class="hidden-md-down"><?php echo e(Auth::user()->name); ?> &nbsp;<i class="fa fa-angle-down"></i></span> </a>
								...
								<?php $profile = \App\Models\Crest\profile::where('user_id', auth()->user()->id)->first(); ?>
									<?php if(isset($profile)): ?>
										<a href="/profiles/show/<?php echo e($profile->id); ?> " class="dropdown-item">View Profile</a>
										<a href="/profiles/edit/<?php echo e($profile->id); ?>" class="dropdown-item">Edit Profile</a>
										<a href="<?php echo e(route('profiles.profile.viewer',  $profile->id)); ?>" class="dropdown-item">Activity</a>
									<?php endif; ?>
...
<!-- ============================================================== -->
	...
	<!--Wave Effects -->
	<script src="<?php echo e($assets_path_public_eli); ?>dist/js/waves.js"></script>
	<!--Menu sidebar -->
	<script src="<?php echo e($assets_path_public_eli); ?>dist/js/sidebarmenu.js"></script>
	<!--Custom JavaScript -->
	<script src="<?php echo e($assets_path_public_eli); ?>dist/js/custom.min.js"></script>
	<!-- ============================================================== -->
	<!-- This page plugins -->
	<!-- ============================================================== -->
	<!--morris JavaScript -->
	<!--<script src="<?php echo e($assets_path_public_eli); ?>node_modules/raphael/raphael-min.js"></script>-->
	<!--<script src="<?php echo e($assets_path_public_eli); ?>node_modules/morrisjs/morris.min.js"></script>-->
	<script src="<?php echo e($assets_path_public_eli); ?>node_modules/jquery-sparkline/jquery.sparkline.min.js"></script>
	<!-- Popup message jquery -->
	<script src="<?php echo e($assets_path_public_eli); ?>node_modules/toast-master/js/jquery.toast.js"></script>
	<!-- Chart JS -->
	<!--<script src="<?php echo e($assets_path_public_eli); ?>dist/js/dashboard1.js"></script>-->
	<!-- Calendar JavaScript -->
	
	
	<script src="<?php echo e($assets_path_public_eli); ?>node_modules/moment/moment.js"></script>
	<script src="<?php echo e($assets_path_public_eli); ?>node_modules/calendar/dist/fullcalendar.min.js"></script>
	<script src="<?php echo e($assets_path_public_eli); ?>node_modules/calendar/dist/cal-init.js"></script>
	...
	<script src="<?php echo e($assets_path_public_eli); ?>node_modules/popper/popper.min.js"></script>
	<script src="<?php echo e($assets_path_public_eli); ?>node_modules/bootstrap/dist/js/bootstrap.min.js"></script>
	<!-- slimscrollbar scrollbar JavaScript -->
	<script src="<?php echo e($assets_path_public_eli); ?>dist/js/perfect-scrollbar.jquery.min.js"></script>
		<script type="text/javascript">
              $('#chat, #msg, #comment, #todo').perfectScrollbar();
	</script>
	<script src="<?php echo e($assets_path); ?>js/Owl/dist/owl.carousel.min.js"></script>
    ...
    <script src="<?php echo e($assets_path); ?>js/prettyphoto/js/jquery.prettyPhoto.js" type="text/javascript" charset="utf-8"></script>
...
<?php /**PATH /home/bidhub/bidhub/resources/views/layouts/app.blade.php ENDPATH**/ ?>