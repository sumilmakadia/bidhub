...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<link rel="icon" type="image/png" sizes="16x16" href="<?php echo e($assets_path_public_eli); ?>images/favicon.png">
	<title><?php echo e(Voyager::setting("admin.title")); ?></title>

	<!-- page css -->
	<link href="<?php echo e($assets_path_public_eli); ?>dist/css/pages/login-register-lock.css" rel="stylesheet">
	<!-- Custom CSS -->
...
<body class="skin-default card-no-border">
	...
	<div class="preloader">
		<div class="loader">
			...
			<p class="loader__label"><?php echo e(Voyager::setting("admin.title")); ?></p>
		</div>
	</div>
	<!-- ============================================================== -->
	...
	<!-- ============================================================== -->
	<section id="wrapper">
		<div class="login-register" style="background-image:url('<?php echo e($assets_path_public_eli); ?>images/background/bidhub_login_screen.jpg')">
			<div class="login-box card">
				<div class="card-body">
				    
				    <?php if(Session::has('redirectlogin_ses')): ?>
                  <p class="alert text-center <?php echo e(Session::get('alert-class', 'alert-danger')); ?>"><?php echo e(Session::get('redirectlogin_ses')); ?></p>
                  <?php endif; ?>
					...
					<div class="col-8 mx-auto mb-20 text-center">
						...
						<!-- <div class="col-12">
							...
							<!--<div class="controls">
								<input type="text" name="email" id="email" value="" placeholder="<?php echo e(__('voyager::generic.email')); ?>" class="form-control" required autocomplete="false">
							</div>-->
						</div>
						...
						<!--	<div class="controls">
								<input type="password" name="password" placeholder="<?php echo e(__('voyager::generic.password')); ?>" class="form-control" required autocomplete="false">
							</div>-->
						</div>
						
						<div class="wrap-input100 validate-input">
                            <input class="input100" type="password" name="password" placeholder="<?php echo e(__('voyager::generic.password')); ?>" required autocomplete="false">
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
						...
						<div class="text-center">
							<div class="col-xs-12 p-b-20">
								<button class="btn btn-block btn-lg btn-info btn-graycustome btn-rounded" type="submit"><!--<?php echo e(__('voyager::generic.login')); ?>--> Login Now</button>
							</div>
						</div>
						    </div>
...
<?php /**PATH /home/bidhub/bidhub/resources/views/vendor/voyager/login.blade.php ENDPATH**/ ?>