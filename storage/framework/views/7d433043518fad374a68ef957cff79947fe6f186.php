		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor"><?php echo e(trans('properties.create')); ?></h4>
				</div>
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						<a href="<?php echo e(route('property-for-sale.property.index')); ?>" class="btn btn-info m-l-15 float-right" title="<?php echo e(trans('properties.show_all')); ?>">
							<i class="fa fa-plus-circle"></i> <?php echo e(trans('properties.show_all')); ?>
				...
				<div class="col-md-8 mx-auto">
					...
					<div class="card">
						<div class="card-body">
							...
							<form method="POST" autocomplete="off" action="<?php echo e(route('property-for-sale.property.store')); ?>" accept-charset="UTF-8" id="create_property_form" name="create_property_form" class="form-horizontal" enctype="multipart/form-data">
								<?php echo e(csrf_field()); ?>

								<?php echo $__env->make('property-for-sale.form', [
										        'property' => null,
										      ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

								<div class="form-group">
									<div class="col-md-12">
										<input class="btn btn-info d-lg-block m-l-15" style="width:100%;margin-top:20px;" type="submit" value="<?php echo e(trans('properties.add')); ?>">
									</div>
								</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bidhub/bidhub/resources/views/property-for-sale/create.blade.php ENDPATH**/ ?>