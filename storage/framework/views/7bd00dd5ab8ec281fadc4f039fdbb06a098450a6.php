	...
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor"><?php echo e(!empty($help->title) ? $help->title : 'Help'); ?></h4>
			</div>
			<div class="col-md-7 align-self-center text-right">
				<div class="d-flex justify-content-end align-items-center">
 <a href="<?php echo e(route('help-wanted.help.index')); ?>" class="btn btn-info m-l-15 float-right" title="<?php echo e(trans('helps.show_all')); ?>">
                        <i class="fa fa-plus-circle"></i>
	 Show All Help Wanted
                </a>
                				</div>
			</div>
		</div>
		<div class="row">
            ...
            <form method="POST" action="<?php echo e(route('help-wanted.help.update', $help->id)); ?>" id="edit_help_form" name="edit_help_form" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
            <?php echo e(csrf_field()); ?>

            <input name="_method" type="hidden" value="PUT">
            <?php echo $__env->make('help-wanted.form', [
                                        'help' => $help,
                                      ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                <div class="form-group">
                    <div class="col-md-12">
                        <input class="btn btn-info d-lg-block m-l-15" style="width: 100%;margin-top: 30px;" type="submit" value="<?php echo e(trans('helps.update')); ?>" style="width:100%;">
                    </div>
                </div>
            </form>
            </div>
...
<?php $__env->startSection('js'); ?>
	...
	<script>
              ...
              $('#edit_help_form').submit(function() {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bidhub/bidhub/resources/views/help-wanted/edit.blade.php ENDPATH**/ ?>