...
return [
    ...
    'age' => 'Age',
    'age__placeholder' => 'age',
    'role' => 'Role',
    'role__placeholder' => 'role',
    'lat' => 'Lat',
    'lat__placeholder' => 'lat',
    'long' => 'Long',
    'long__placeholder' => 'long',
    ...
    'index_route_description' => 'Retrieve existing profiles.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the profile property name where the value is the assigned value to the retrieved profile.',
    ...
    'show_route_description' => 'Retrieve existsing profile.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the profile to retrieve',
    'destroy_route_description' => 'Delete existsing profile.',
    ...
    'the_id_of_model_to_delete' => 'The id of the profile to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete profiles.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the profile.',
    ...
    'the_requested_model_does_not_exists' => 'The requested profile does not exists.',
    ...
    'edit' => 'Edit Profile',
    'show' => 'Show Profile',
    'show_all' => 'Show All Profile',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Profile.',
    'none_available' => 'No Profiles Available.',
    'model_plural' => 'Profiles',
    'model_was_added' => 'Profile was successfully added.',
    'model_was_retrieved' => 'Profile was successfully retrieved.',
    'models_were_retrieved' => 'Profiles were successfully retrieved.',
    'model_was_updated' => 'Profile was successfully updated.',
    'model_was_deleted' => 'Profile was successfully deleted.',
