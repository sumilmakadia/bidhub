...
return [
    ...
    'index_route_description' => 'Retrieve existing ybr notifications.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the ybr notification property name where the value is the assigned value to the retrieved ybr notification.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved ybr notification.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of ybr notifications per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved ybr notification.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new ybr notification.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing ybr notification.',
    ...
    'show_route_description' => 'Retrieve existsing ybr notification.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the ybr notification to retrieve',
    'destroy_route_description' => 'Delete existsing ybr notification.',
    ...
    'the_id_of_model_to_delete' => 'The id of the ybr notification to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete ybr notifications.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the ybr notification.',
    ...
    'the_requested_model_does_not_exists' => 'The requested ybr notification does not exists.',
    ...
    'create' => 'Create New Ybr Notification',
    'delete' => 'Delete Ybr Notification',
    'edit' => 'Edit Ybr Notification',
    'show' => 'Show Ybr Notification',
    'show_all' => 'Show All Ybr Notification',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Ybr Notification.',
    'none_available' => 'No Ybr Notifications Available.',
    'model_plural' => 'Ybr Notifications',
    'model_was_added' => 'Ybr Notification was successfully added.',
    'model_was_retrieved' => 'Ybr Notification was successfully retrieved.',
    'models_were_retrieved' => 'Ybr Notifications were successfully retrieved.',
    'model_was_updated' => 'Ybr Notification was successfully updated.',
    'model_was_deleted' => 'Ybr Notification was successfully deleted.',
    ...
    'model_id_camel_case' => 'ybr notificationId',
