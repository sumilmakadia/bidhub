...
return [
    ...
    'index_route_description' => 'Retrieve existing favorites.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the favorite property name where the value is the assigned value to the retrieved favorite.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved favorite.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of favorites per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved favorite.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new favorite.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing favorite.',
    ...
    'show_route_description' => 'Retrieve existsing favorite.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the favorite to retrieve',
    'destroy_route_description' => 'Delete existsing favorite.',
    ...
    'the_id_of_model_to_delete' => 'The id of the favorite to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete favorites.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the favorite.',
    ...
    'the_requested_model_does_not_exists' => 'The requested favorite does not exists.',
    ...
    'create' => 'Create New Favorite',
    'delete' => 'Delete Favorite',
    'edit' => 'Edit Favorite',
    'show' => 'Show Favorite',
    'show_all' => 'Show All Favorite',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Favorite.',
    'none_available' => 'No Favorites Available.',
    'model_plural' => 'Favorites',
    'model_was_added' => 'Favorite was successfully added.',
    'model_was_retrieved' => 'Favorite was successfully retrieved.',
    'models_were_retrieved' => 'Favorites were successfully retrieved.',
    'model_was_updated' => 'Favorite was successfully updated.',
    'model_was_deleted' => 'Favorite was successfully deleted.',
    ...
    'model_id_camel_case' => 'favoriteId',
