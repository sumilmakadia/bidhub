...
return [
    ...
    'index_route_description' => 'Retrieve existing ybr membership5 transactions.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the ybr membership5 transaction property name where the value is the assigned value to the retrieved ybr membership5 transaction.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved ybr membership5 transaction.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of ybr membership5 transactions per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved ybr membership5 transaction.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new ybr membership5 transaction.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing ybr membership5 transaction.',
    ...
    'show_route_description' => 'Retrieve existsing ybr membership5 transaction.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the ybr membership5 transaction to retrieve',
    'destroy_route_description' => 'Delete existsing ybr membership5 transaction.',
    ...
    'the_id_of_model_to_delete' => 'The id of the ybr membership5 transaction to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete ybr membership5 transactions.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the ybr membership5 transaction.',
    ...
    'the_requested_model_does_not_exists' => 'The requested ybr membership5 transaction does not exists.',
    ...
    'create' => 'Create New Ybr Membership5 Transaction',
    'delete' => 'Delete Ybr Membership5 Transaction',
    'edit' => 'Edit Ybr Membership5 Transaction',
    'show' => 'Show Ybr Membership5 Transaction',
    'show_all' => 'Show All Ybr Membership5 Transaction',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Ybr Membership5 Transaction.',
    'none_available' => 'No Ybr Membership5 Transactions Available.',
    'model_plural' => 'Ybr Membership5 Transactions',
    'model_was_added' => 'Ybr Membership5 Transaction was successfully added.',
    'model_was_retrieved' => 'Ybr Membership5 Transaction was successfully retrieved.',
    'models_were_retrieved' => 'Ybr Membership5 Transactions were successfully retrieved.',
    'model_was_updated' => 'Ybr Membership5 Transaction was successfully updated.',
    'model_was_deleted' => 'Ybr Membership5 Transaction was successfully deleted.',
    ...
    'model_id_camel_case' => 'ybr membership5 transactionId',
