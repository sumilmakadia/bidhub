...
return [
    ...
    'role_id' => 'Role',
    'role_id__placeholder' => 'Select role',
    'access_token_with_bearer' => 'The access token prefixed with the "Bearer " key word.',
    'index_route_description' => 'Retrieve existing user roles.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the user role property name where the value is the assigned value to the retrieved user role.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved user role.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of user roles per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved user role.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new user role.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing user role.',
    ...
    'show_route_description' => 'Retrieve existsing user role.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the user role to retrieve',
    'destroy_route_description' => 'Delete existsing user role.',
    ...
    'the_id_of_model_to_delete' => 'The id of the user role to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete user roles.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the user role.',
    ...
    'the_requested_model_does_not_exists' => 'The requested user role does not exists.',
    ...
    'edit' => 'Edit User Role',
    'show' => 'Show User Role',
    'show_all' => 'Show All User Role',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete User Role.',
    'none_available' => 'No User Roles Available.',
    'model_plural' => 'User Roles',
    'model_was_added' => 'User Role was successfully added.',
    'model_was_retrieved' => 'User Role was successfully retrieved.',
    'models_were_retrieved' => 'User Roles were successfully retrieved.',
    'model_was_updated' => 'User Role was successfully updated.',
    'model_was_deleted' => 'User Role was successfully deleted.',
    ...
    'model_id_camel_case' => 'user roleId',
