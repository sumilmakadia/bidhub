...
return [
    ...
    'budget_title__placeholder' => 'budget title',
    'budget_amount' => 'Budget Amount',
    'budget_amount__placeholder' => 'budget amount',
    'budget_status' => 'Budget Status',
    'budget_status__placeholder' => 'budget status',
    ...
    'index_route_description' => 'Retrieve existing budgets.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the budget property name where the value is the assigned value to the retrieved budget.',
    ...
    'show_route_description' => 'Retrieve existsing budget.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the budget to retrieve',
    'destroy_route_description' => 'Delete existsing budget.',
    ...
    'the_id_of_model_to_delete' => 'The id of the budget to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete budgets.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the budget.',
    ...
    'the_requested_model_does_not_exists' => 'The requested budget does not exists.',
    ...
    'edit' => 'Edit Budget',
    'show' => 'Show Budget',
    'show_all' => 'Show All Budget',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Budget.',
    'none_available' => 'No Budgets Available.',
    'model_plural' => 'Budgets',
    'model_was_added' => 'Budget was successfully added.',
    'model_was_retrieved' => 'Budget was successfully retrieved.',
    'models_were_retrieved' => 'Budgets were successfully retrieved.',
    'model_was_updated' => 'Budget was successfully updated.',
    'model_was_deleted' => 'Budget was successfully deleted.',
