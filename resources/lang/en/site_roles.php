...
return [
    ...
    'display_name__placeholder' => 'display name',
    ...
    'index_route_description' => 'Retrieve existing site roles.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the site role property name where the value is the assigned value to the retrieved site role.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved site role.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of site roles per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved site role.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new site role.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing site role.',
    ...
    'show_route_description' => 'Retrieve existsing site role.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the site role to retrieve',
    'destroy_route_description' => 'Delete existsing site role.',
    ...
    'the_id_of_model_to_delete' => 'The id of the site role to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete site roles.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the site role.',
    ...
    'the_requested_model_does_not_exists' => 'The requested site role does not exists.',
    ...
    'create' => 'Create New Site Role',
    'delete' => 'Delete Site Role',
    'edit' => 'Edit Site Role',
    'show' => 'Show Site Role',
    'show_all' => 'Show All Site Role',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Site Role.',
    'none_available' => 'No Site Roles Available.',
    'model_plural' => 'Site Roles',
    'model_was_added' => 'Site Role was successfully added.',
    'model_was_retrieved' => 'Site Role was successfully retrieved.',
    'models_were_retrieved' => 'Site Roles were successfully retrieved.',
    'model_was_updated' => 'Site Role was successfully updated.',
    'model_was_deleted' => 'Site Role was successfully deleted.',
    ...
    'model_id_camel_case' => 'site roleId',
