...
return [
    ...
    'index_route_description' => 'Retrieve existing files.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the file property name where the value is the assigned value to the retrieved file.',
    ...
    'show_route_description' => 'Retrieve existsing file.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the file to retrieve',
    'destroy_route_description' => 'Delete existsing file.',
    ...
    'the_id_of_model_to_delete' => 'The id of the file to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete files.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the file.',
    ...
    'the_requested_model_does_not_exists' => 'The requested file does not exists.',
    ...
    'edit' => 'Edit File',
    'show' => 'Show File',
    'show_all' => 'Show All File',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete File.',
    'none_available' => 'No Files Available.',
    'model_plural' => 'Files',
    'model_was_added' => 'File was successfully added.',
    'model_was_retrieved' => 'File was successfully retrieved.',
    'models_were_retrieved' => 'Files were successfully retrieved.',
    'model_was_updated' => 'File was successfully updated.',
    'model_was_deleted' => 'File was successfully deleted.',
