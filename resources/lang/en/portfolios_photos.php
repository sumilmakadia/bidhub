...
return [
    ...
    'portfolio_id__placeholder' => 'Select portfolio',
    'file_name' => 'File Name',
    ...
    'index_route_description' => 'Retrieve existing portfolios photos.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the portfolios photo property name where the value is the assigned value to the retrieved portfolios photo.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved portfolios photo.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of portfolios photos per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved portfolios photo.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new portfolios photo.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing portfolios photo.',
    ...
    'show_route_description' => 'Retrieve existsing portfolios photo.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the portfolios photo to retrieve',
    'destroy_route_description' => 'Delete existsing portfolios photo.',
    ...
    'the_id_of_model_to_delete' => 'The id of the portfolios photo to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete portfolios photos.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the portfolios photo.',
    ...
    'the_requested_model_does_not_exists' => 'The requested portfolios photo does not exists.',
    ...
    'create' => 'Create New Portfolios Photo',
    'delete' => 'Delete Portfolios Photo',
    'edit' => 'Edit Portfolios Photo',
    'show' => 'Show Portfolios Photo',
    'show_all' => 'Show All Portfolios Photo',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Portfolios Photo.',
    'none_available' => 'No Portfolios Photos Available.',
    'model_plural' => 'Portfolios Photos',
    'model_was_added' => 'Portfolios Photo was successfully added.',
    'model_was_retrieved' => 'Portfolios Photo was successfully retrieved.',
    'models_were_retrieved' => 'Portfolios Photos were successfully retrieved.',
    'model_was_updated' => 'Portfolios Photo was successfully updated.',
    'model_was_deleted' => 'Portfolios Photo was successfully deleted.',
    ...
    'model_id_camel_case' => 'portfolios photoId',
