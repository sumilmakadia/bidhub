...
return [
    ...
    'proposal_id__placeholder' => 'Select proposal',
    'owner_id' => 'Owner',
    'owner_id__placeholder' => 'Select owner',
    'guest_id' => 'Guest',
    'guest_id__placeholder' => 'Select guest',
    ...
    'index_route_description' => 'Retrieve existing chatrooms.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the chatroom property name where the value is the assigned value to the retrieved chatroom.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved chatroom.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of chatrooms per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved chatroom.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new chatroom.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing chatroom.',
    ...
    'show_route_description' => 'Retrieve existsing chatroom.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the chatroom to retrieve',
    'destroy_route_description' => 'Delete existsing chatroom.',
    ...
    'the_id_of_model_to_delete' => 'The id of the chatroom to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete chatrooms.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the chatroom.',
    ...
    'the_requested_model_does_not_exists' => 'The requested chatroom does not exists.',
    ...
    'edit' => 'Edit Chatroom',
    'show' => 'Show Chatroom',
    'show_all' => 'Show All Chatroom',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Chatroom.',
    'none_available' => 'No Chatrooms Available.',
    'model_plural' => 'Chatrooms',
    'model_was_added' => 'Chatroom was successfully added.',
    'model_was_retrieved' => 'Chatroom was successfully retrieved.',
    'models_were_retrieved' => 'Chatrooms were successfully retrieved.',
    'model_was_updated' => 'Chatroom was successfully updated.',
    'model_was_deleted' => 'Chatroom was successfully deleted.',
    ...
    'model_id_camel_case' => 'chatroomId',
