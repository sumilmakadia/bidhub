...
return [
    ...
    'id__placeholder' => 'id',
    'author_id' => 'Author',
    'author_id__placeholder' => 'Select author',
    'title' => 'Title',
    'title__placeholder' => 'title',
    'excerpt' => 'Excerpt',
    'excerpt__placeholder' => 'excerpt',
    'body' => 'Body',
    'body__placeholder' => 'body',
    'image' => 'Image',
    'image__placeholder' => 'image',
    'slug' => 'Slug',
    'slug__placeholder' => 'slug',
    'meta_description' => 'Meta Description',
    'meta_description__placeholder' => 'meta description',
    'meta_keywords' => 'Meta Keywords',
    'meta_keywords__placeholder' => 'meta keywords',
    'status' => 'Status',
    ...
    'index_route_description' => 'Retrieve existing pages.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the page property name where the value is the assigned value to the retrieved page.',
    ...
    'show_route_description' => 'Retrieve existsing page.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the page to retrieve',
    'destroy_route_description' => 'Delete existsing page.',
    ...
    'the_id_of_model_to_delete' => 'The id of the page to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete pages.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the page.',
    ...
    'the_requested_model_does_not_exists' => 'The requested page does not exists.',
    ...
    'edit' => 'Edit Page',
    'show' => 'Show Page',
    'show_all' => 'Show All Page',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Page.',
    'none_available' => 'No Pages Available.',
    'model_plural' => 'Pages',
    'model_was_added' => 'Page was successfully added.',
    'model_was_retrieved' => 'Page was successfully retrieved.',
    'models_were_retrieved' => 'Pages were successfully retrieved.',
    'model_was_updated' => 'Page was successfully updated.',
    'model_was_deleted' => 'Page was successfully deleted.',
