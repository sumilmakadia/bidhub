	...
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor">Create New Marketplace Category</h4>
			</div>
			<div class="col-md-7 align-self-center text-right">
				<div class="d-flex justify-content-end align-items-center">
				  <!--<a href="{{ route('market-place.marketplace.index') }}" class="btn btn-info m-l-15 float-right" title="{{ trans('marketplaces.show_all') }}">-->
      <!--                                    <i class="fa fa-plus-circle"></i> {{ trans('marketplaces.show_all') }}-->
      <!--                           </a>-->
                                 	</div>
			</div>
		</div>
		<div class="row">
			<div class="col-8 mx-auto">
			 ...
			 @if ($errors->any())
                        ...
                        <form method="POST" action="{{ route('market-place.marketplace.store-category') }}" accept-charset="UTF-8" id="create_marketplace_form" name="create_marketplace_form" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @include ('market-place.form-category', [
                                                    'marketplace' => null,
                                                  ])

                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-10">
                                    <input class="btn btn-info d-none d-lg-block m-l-15" type="submit" value="{{ trans('marketplaces.add') }}">
                                </div>
                            </div>
