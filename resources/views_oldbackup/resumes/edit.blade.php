	...
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor">{{ !empty($title) ? $title : 'resume' }}</h4>
			</div>
			<div class="col-md-7 align-self-center text-right">
				<div class="d-flex justify-content-end align-items-center">
 <a href="{{ route('resumes.resume.index') }}" class="btn btn-info m-l-15 float-right" title="{{ trans('resumes.show_all') }}">
                        <i class="fa fa-plus-circle"></i>
                        {{ trans('resumes.show_all') }}
                </a>
                				</div>
			</div>
		</div>
		<div class="row">
            ...
            <form method="POST" autocomplete="off" action="{{ route('resumes.resume.update', $resume->id) }}" id="edit_resume_form" name="edit_resume_form" enctype="multipart/form-data" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @include ('resumes.form', [
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-info d-none d-lg-block m-l-15" type="submit" value="{{ trans('resumes.update') }}">
                    </div>
                </div>
            </form>
            </div>
