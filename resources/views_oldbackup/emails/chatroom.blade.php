											...
											<td valign="top" id="body_content" style="background-color: #ffffff;">
												...
												<table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_body" style="font-family:raleway; font-size:20px; margin-left:30px;margin-top:35px;">
                                                    <tr>
														...
														<td style="padding-left: 8px; width:1px;"><img src="{{ asset('') . $chat_message->user->avatar }}" width="60" height="60" alt="No User Picture" style="border: 1px solid #edf1f5;"></td>
                                                        <td style="padding-left: 8px; text-align:left;font-weight: bold;color:#000;font-family:raleway;" valign="top">{{ $chat_message->profile->first_name . ' ' . $chat_message->profile->last_name }}</td>
													</tr>
												</table>
												<table border="0" cellpadding="0" cellspacing="0" width="580" id="template_body" style="font-family:raleway; font-size:20px; margin-top:70px; margin-left:30px;">
                                                    <tr>
														<td style="width:580px;color:#000;font-family:raleway;">Message: {{ $message }}</td>
													</tr>
												</table>
