		...
		<div class="container-fluid">
			<div class="row page-titles">
				...
				<div class="col-md-7 align-self-center text-right">
					...
					{{-- $fav_user = \App\Models\Crest\favorite::where('created_by', Auth::user()->id)->where('favorite_type', 'favorite_users')->where('favorite_id',Auth::user()->id)->first(); ?>
						@if ($fav_user)
						...
						<div class="card-body">
							...
							@foreach($portfolios as $portfolio)
								...
								<div class="col-lg-4 col-md-6 m-b-20">
									...
									<img src="{{$portfolio->file_path}}" class="img-responsive radius mb-20" alt="">
