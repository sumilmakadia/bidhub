													...
													<div class="col-6">
														<div class="row">
															<div class="col-12 mb-20">
																<a href="{{ route('profiles.profile.show', $profile->id) }}" class="btn btn-warning">View</a>
																<a href="{{ route('profiles.profile.show', $profile->id) }}" class="btn btn-info">Invite</a>
															</div>
															<div class="col-12">
																<h4>Trades Offered</h4>
