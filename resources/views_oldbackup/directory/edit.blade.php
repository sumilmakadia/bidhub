	...
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor">{{ !empty($title) ? $title : 'Free Directories' }}</h4>
			</div>
			<div class="col-md-7 align-self-center text-right">
				<div class="d-flex justify-content-end align-items-center">
 <a href="{{ route('directory.free-directories.admin') }}" class="btn btn-info m-l-15 float-right" title="{{ trans('free-directories.admin') }}">
		...
		<div class="row">
            ...
            <form method="POST" action="{{ route('directory.directories.update', $directories->id) }}" id="edit_directories_form" name="edit_directories_form" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            @include ('directory.form', [
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-info d-none d-lg-block m-l-15" type="submit" value="{{ trans('directories.update') }}">
                    </div>
                </div>
            </form>
            </div>
