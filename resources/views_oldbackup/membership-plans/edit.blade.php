...
<div class="page-wrapper" style="min-height: 149px;">
 ...
 <a href="{{ route('membership-plans.ybr_membership2_plan.index') }}" class="btn btn-info m-l-15 float-right" title="{{ trans('ybr_membership2_plans.show_all') }}">
		...
		<div class="row">
            ...
            <form method="POST" action="{{ route('membership-plans.ybr_membership2_plan.update', $ybrMembership2Plan->id) }}" id="edit_ybr_membership2_plan_form" name="edit_ybr_membership2_plan_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
