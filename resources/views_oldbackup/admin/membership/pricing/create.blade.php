		...
		<div class="row">
			<div class="col-12">
			 ...
			 @if ($errors->any())
                        ...
                        <form method="POST" action="{{ route('pricing.ybr_membership2_plan.store') }}" accept-charset="UTF-8" id="create_ybr_membership2_plan_form" name="create_ybr_membership2_plan_form" class="form-horizontal">
                        {{ csrf_field() }}
