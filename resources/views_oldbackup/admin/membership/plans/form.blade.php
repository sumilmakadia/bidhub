...
<!--        	    <option value="" style="display: none;" {{ old('product_id', optional($ybrMembership2Plan)->product_id ?: '') == '' ? 'selected' : '' }} disabled selected>{{ trans('ybr_membership2_plans.product_id__placeholder') }}</option>-->
<!--        	@foreach ($YbrMembership1Products as $key => $YbrMembership1Product)-->
<!--			    <option value="{{ $key }}" {{ old('product_id', optional($ybrMembership2Plan)->product_id) == $key ? 'selected' : '' }}>-->
<!--			    	{{ $YbrMembership1Product }}-->
<!--			    </option>-->
<!--			@endforeach-->
<!--        </select>-->
...
<div class="form-group {{ $errors->has('plan_description') ? 'has-error' : '' }}">
    ...
    <div class="col-md-12">
        <textarea class="form-control" name="plan_description" cols="50" rows="10" id="plan_description" placeholder="Comma Seperated Features">{{ old('plan_description', optional($ybrMembership2Plan)->plan_description) }}</textarea>
...
<!--    <div class="col-md-12">-->
<!--        <textarea class="form-control" name="plan_object" cols="50" rows="10" id="plan_object" placeholder="Comma Seperated Features">{{ old('plan_object', optional($ybrMembership2Plan)->plan_object) }}</textarea>-->
...
<!--    <div class="col-md-12">-->
<!--        <input class="form-control" name="plan_interval" type="text" id="plan_interval" value="{{ old('plan_interval', optional($ybrMembership2Plan)->plan_interval) }}" maxlength="100" placeholder="Plan Interval">-->
...
<!--    <div class="col-md-10">-->
<!--        <input class="form-control" name="plan_interval_count" type="text" id="plan_interval_count" value="{{ old('plan_interval_count', optional($ybrMembership2Plan)->plan_interval_count) }}" min="0" max="100" placeholder="Plan Interavel (days)">-->
<!--        {!! $errors->first('plan_interval_count', '<p class="help-block">:message</p>') !!}-->
<!--    </div>-->
<!--</div>-->

<div class="form-group {{ $errors->has('plan_livemode') ? 'has-error' : '' }} row">
    ...
    <div class="col-md-4" style="padding: 10px;">
        ...
        <input class="" name="plan_livemode" type="radio" id="plan_livemode" value="1" maxlength="100" {{$selected_yes}}> Yes
        <input class="" name="plan_livemode" type="radio" id="plan_livemode" value="0" maxlength="100" {{$selected_no}}> No
