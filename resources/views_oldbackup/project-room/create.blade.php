		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor">{{ trans('projects.create') }}</h4>
				</div>
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						<a href="{{ route('project-room.project.index') }}" class="btn btn-info m-l-15 float-right" title="{{ trans('projects.show_all') }}">
							<i class="fa fa-plus-circle"></i> {{ trans('projects.show_all') }}
						</a>
					</div>
				</div>
			</div>
				...
				<div class="col-md-8 mx-auto">
					...
					<div class="card">
						<div class="card-body">
							...
							<form method="POST" autocomplete="off" action="{{ route('project-room.project.store') }}" accept-charset="UTF-8" id="create_project_form" name="create_project_form" class="form-horizontal" enctype="multipart/form-data">
								{{ csrf_field() }}
								...
								<div class="form-group">
									<div class="col-md-120">
										<button class="btn btn-info d-lg-block m-l-15" style="width:100%;margin-top:20px;" type="submit" value="{{ trans('projects.add') }}">Submit</button>
									</div>
								</div>
