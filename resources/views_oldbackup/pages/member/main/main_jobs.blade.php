...
<div class="col-12">
	<div class="card">
		<div class="row">
			...
			<div class="col">
				<input type="text" class="form-control" placeholder="Detected Location (89117)">
			</div>
			<div class="col">
				<select name="trades[]" id="trades" class="form-control">
			...
			<div class="d-flex no-block comment-row">
				...
				<div class="comment-text w-100">
					<div class="col-12">
						       <div class="row">
							       <div class="col-10">
								       <h5 class="font-medium">Lorem Ipsum is simply dummy tex</h5>
								       <span class="text-muted pull-right">April 14, 2016</span>
							       </div>
							       <div class="col-2">
								       <span class="btn-info btn">Apply</span>
							       </div>
