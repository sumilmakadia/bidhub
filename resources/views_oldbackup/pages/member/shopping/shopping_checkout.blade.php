...
.error{
    ...
    <div class="col-md-12" style="background-color: #03a9f3;margin-bottom: 10px;">
        ...
        <center><h3 style="padding: 15px 0 5px!important;font-weight: bold;color: #ffffff;">{{$plan->plan_name}} - ${{$plan->plan_amount}} <span style="font-size:14px;">per month</span></h3></center>
