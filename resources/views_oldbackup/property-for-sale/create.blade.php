		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor">{{ trans('properties.create') }}</h4>
				</div>
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						<a href="{{ route('property-for-sale.property.index') }}" class="btn btn-info m-l-15 float-right" title="{{ trans('properties.show_all') }}">
							<i class="fa fa-plus-circle"></i> {{ trans('properties.show_all') }}
						</a>
					</div>
				</div>
			</div>
				...
				<div class="col-md-8 mx-auto">
					...
					<div class="card">
						<div class="card-body">
							...
							<form method="POST" autocomplete="off" action="{{ route('property-for-sale.property.store') }}" accept-charset="UTF-8" id="create_property_form" name="create_property_form" class="form-horizontal" enctype="multipart/form-data">
								{{ csrf_field() }}
								...
								<div class="form-group">
									<div class="col-md-12">
										<input class="btn btn-info d-lg-block m-l-15" style="width:100%;margin-top:20px;" type="submit" value="{{ trans('properties.add') }}">
									</div>
								</div>
