		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor">{{ !empty($title) ? $title : 'Property' }}</h4>
				</div>
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						<a href="{{ route('property-for-sale.property.index') }}" class="btn btn-info m-l-15 float-right" title="{{ trans('properties.show_all') }}">
							<i class="fa fa-plus-circle"></i>
							{{ trans('properties.show_all') }}
						</a>
					</div>
				</div>
			</div>
				...
				<div class="col-md-8 mx-auto">
					<div class="card">
						<div class="card-body">
							...
							<form method="POST" autocomplete="off" action="{{ route('property-for-sale.property.update', $property->id) }}" id="edit_property_form" name="edit_property_form" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
								{{ csrf_field() }}
								<input name="_method" type="hidden" value="PUT">
								@include ('property-for-sale.form', [
										        'property' => $property,
										      ])

								<div class="form-group">
									<div class="col-md-12">
										<input class="btn btn-info d-lg-block m-l-15" style="width: 100%;margin-top: 30px;" type="submit" value="{{ trans('properties.update') }}">
									</div>
								</div>
							</form>
						</div>
...
//         },
    ...
    $( '.delete-file' ).click(function(e) {
		    ...
		    $('#'+id).hide();
				$.ajax({
					type: 'post',
					url: '/property-for-sale/remove-file',
					data: {
		...
		$( '.delete-galery' ).click(function(e) {
		    ...
		    $('#'+id).hide();
				$.ajax({
					type: 'post',
					url: '/property-for-sale/remove-galery',
					data: {
					    '_token': $('meta[name="csrf-token"]').attr('content'),
					    'id': $(this).data( "id" ),
					},
