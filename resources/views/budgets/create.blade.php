				...
				<div class="col-8 mx-auto">
							...
							<div class="row total_budget mb-20">
								<div class="col-4">
									<div class="form-group {{ $errors->has('budget_title') ? 'has-error' : '' }}">
										<div class="input-group">
											<input type="text" class="form-control" name="budget_title" id="field_budget_title"  value="" placeholder="Budget Title">
										</div>
									</div>
								</div>
								<div class="col-4">
								...
								<div class="col-4">
									...
									<div class="input-group col-sm-6">
										...
										<input type="number" class="form-control" name="field_total_budget" id="field_total_budget" value="" placeholder="0.00">
									</div>
								</div>
							</div>
											...
											<table class="table table-striped">
												...
												<tr>
													...
													<td>
														<div class="input-group">
															<span class="input-group-addon">$</span>
															<input type="number" name="item_amount" class="form-control item_amount" oninput='calculate_total()' value="0" placeholder="0.00">
														</div>
													</td>
					...
					<script type="text/javascript">
                                                      ...
                                                      function save_budget() {
                                                          ...
                                                          $.ajax({
                                                              url: baseURL + 'budget-planner/store/' + project,
                                                              method: 'post',
                                                              data: {
                                                                  "items": data,
                                                                  "title": budget_title,
                                                      ...
                                                      function calculate_total() {
                                                          ...
                                                          // jQuery('#field_total_budget').val(items_amount);
                                                      }
