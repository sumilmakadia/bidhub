			...
			<div class="row page-titles">
				...
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						<a href="{{ route('property-for-sale.property.create') }}" class="btn btn-info m-l-15" title="{{ trans('helps.index') }}">
							Create Property
						</a>
					</div>
				</div>
				
				@if (Auth::user()->property == 0 && Auth::user()->role_id != 8 && Auth::user()->role_id != 1)
				<!--<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
