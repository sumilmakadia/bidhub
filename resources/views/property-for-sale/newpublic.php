	...
	<div class="page-wrapper" style="min-height: 149px;">
		<div class="container-fluid">
			<div class="row page-titles">
				...
				@if($user = Auth::user())
				@if (Auth::user()->role_id == 1 || Auth::user()->property != 0 || Auth::user()->role_id == 8 || Auth::user()->role_id == 14)
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						<a href="{{ route('property-for-sale.property.index') }}" class="btn btn-info m-l-15" title="{{ trans('helps.index') }}">
							Manage Property
						</a>
					</div>
				</div>
				@endif
				@if (Auth::user()->property == 0 && Auth::user()->role_id != 8 && Auth::user()->role_id != 1 && Auth::user()->role_id != 14)
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
			...
			<div class="row">
				<div class="col-12">
					@include('property-for-sale/search')
				</div>
			</div>
						...
						<div class="col-lg-3 col-md-6">
							<div class="card">
								<div class="card-image mh-200">
									<a href="{{ route('property-for-sale.property.show', $property->id ) }}">
										<img class="card-img-top img-responsive" src="{{asset($property->property_image)}}" alt=" image cap">
									</a>
								</div>
								<div class="card-body">
									<div class="row mb-20">
										<div class="col">
											...
											<h5 class="font-light">{{$property->property_acres}}</h5>
										</div>
										<div class="col">
											<h3 class="m-b-0"></h3>
										...
										<div class="col">
											...
											<h5 class="font-light">{{money_format('%.2n', $property->property_cost)}}</h5>
										</div>
									</div>
									...
									<p>{{ str_limit($property->property_description,150) }}</p>
									<p class="m-b-0 m-t-10">{{ $property->location }}</p>
