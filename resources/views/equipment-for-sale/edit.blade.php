		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor">{{ !empty($title) ? $title : 'Equipment' }}</h4>
				</div>
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						<a href="{{ route('equipment-for-sale.property.index') }}" class="btn btn-info m-l-15 float-right" title="{{ trans('equipments.show_all') }}">
							<i class="fa fa-plus-circle"></i>
							{{ trans('equipments.show_all') }}
						</a>
					</div>
				</div>
			</div>
				...
				<div class="col-md-8 mx-auto">
					<div class="card">
						<div class="card-body">
							...
							<form method="POST" autocomplete="off" action="{{ route('equipment-for-sale.property.update', $equipment->id) }}" id="edit_property_form" name="edit_property_form" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
								{{ csrf_field() }}
								<input name="_method" type="hidden" value="PUT">
								@include ('equipment-for-sale.form', [
										        'equipment' => $equipment,
										      ])

								<div class="form-group">
									<div class="col-md-12">
										<input class="btn btn-info d-lg-block m-l-15" style="width: 100%;margin-top: 30px;" type="submit" value="{{ trans('equipments.update') }}">
									</div>
								</div>
							</form>
						</div>
