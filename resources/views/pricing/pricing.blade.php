		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor">Manage Membership  @isset(Auth::user()->id)
								...
								@foreach ($plans as $key => $plan)
									<div class="col-md-4 col-xs-12 col-sm-6">
										<div class="pricing-box @if ($key == 2) featured-plan @else b-l @endif">
											<div class="pricing-body card" @if($plan->id != 10) style="min-height: 141px;" @endif>
												...
												<div class="price-table-content">
                                                    ...
                                                    @endif
													<div class="price-row">
														<button id="{{$plan->id}}" class="purchasecs-btn addon-select btn btn-success waves-effect waves-light m-t-20 ess-select">Select</button>
													</div>
													@endif
													@endif
												</div>
										...
										<div class="pricing-box @if ($key == 2) featured-plan @else b-l @endif">
											<div class="pricing-body card">
												...
												<div class="price-table-content">
                    								...
                    								@else
                    								<div class="price-row">
														<button id="{{$adds->id}}" class="purchasecs-btn addon-select btn btn-success waves-effect waves-light m-t-20 @if($adds->type == 1) help-select @endif @if($adds->type == 2) home-select @endif">Select</button>
													</div>
													@endif
												</div>
											</div>
