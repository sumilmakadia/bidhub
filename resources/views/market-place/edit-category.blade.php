...
<div class="page-wrapper" style="min-height: 149px;">
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor">{{ !empty($title) ? $title : 'Marketplace Category Update' }}</h4>
			</div>
 ...
 <!--               </a>-->
		...
		<div class="row">
            ...
            <form method="POST" action="{{ route('market-place.marketplace.update-category', $category->id) }}" id="edit_marketplace_form" name="edit_marketplace_form" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            @include ('market-place.form-category', [
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-info d-none d-lg-block m-l-15" type="submit" value="{{ trans('marketplaces.update') }}">
                    </div>
                </div>
            </form>
            </div>
