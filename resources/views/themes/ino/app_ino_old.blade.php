...
<!--End preloader area-->
@include('themes.ino.parts.preloader')
<!--Start searchForm -->
{{--@include('themes.ino.elements.block0')--}}

<!-- Start color-plate -->
{{	Menu('menu_main_loggedout','themes.ino.parts.navigation')}}
{{--@include('themes.ino.parts.navigation')--}}
<!--End header Area-->
@yield('content')
<!--start footer area-->
{{	Menu('menu_bottom_copyright','themes.ino.parts.footer')}}
<!--End footer area-->
@include('themes.ino.parts.foot')
