        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <a href="{{ route('admin.app.users.user.create') }}" class="btn btn-info m-l-15" title="{{ trans('users.create') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <th>{{ trans('users.remember_token') }}</th>
                                ...
                                <tr>
                                                                <td class="">{{ optional($user->Role)->id }}</td>
                            ...
                            <td class="">{{ $user->remember_token }}</td>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="{!! route('admin.app.users.user.destroy', $user->id) !!}" accept-charset="UTF-8">
                                            <input name="_method" value="DELETE" type="hidden">
                                            {{ csrf_field() }}

                                            <div class="btn-group btn-group-xs pull-right" role="group">
                                                <a href="{{ route('admin.app.users.user.show', $user->id ) }}" class="btn btn-info" title="{{ trans('users.show') }}">
                                                    <span class="glyphicon glyphicon-open" aria-hidden="true"></span>View
                                                </a>
                                                <a href="{{ route('admin.app.users.user.edit', $user->id ) }}" class="btn btn-primary" title="{{ trans('users.edit') }}">
