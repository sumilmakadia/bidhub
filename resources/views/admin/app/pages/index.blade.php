        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <a href="{{ route('admin.app.pages.create') }}" class="btn btn-info m-l-15" title="{{ trans('pages.create') }}">
                        ...
                        <div class="table-responsive">
                            ...
                            <td class="">{{ $page->title }}</td>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="{!! route('admin.app.pages.destroy', $page->id) !!}" accept-charset="UTF-8">
                                            <input name="_method" value="DELETE" type="hidden">
                                            {{ csrf_field() }}

                                            <div class="btn-group btn-group-xs pull-right" role="group">
                                                <a href="{{ route('admin.app.pages.show', $page->id ) }}" class="btn btn-info" title="{{ trans('pages.show') }}">
                                                    <span class="glyphicon glyphicon-open" aria-hidden="true"></span>View
                                                </a>
                                                <a href="{{ route('admin.app.pages.edit', $page->id ) }}" class="btn btn-primary" title="{{ trans('pages.edit') }}">
