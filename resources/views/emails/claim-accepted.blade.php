...
<p style="margin-bottom:15px;padding:40px;">Hello {{$contact_name}},</p>

<p style="margin-bottom:15px;">Congratulations! Your claim listing request for {{$company_name}} has been approved by BidHub!</p>

<p style="margin-bottom:15px;">Sign in and go to your Edit Profile page at this <a href="https://bidhub.com/app/profiles/show/{{$profile_id}}">link</a> to change any information in your listing.</p> 
