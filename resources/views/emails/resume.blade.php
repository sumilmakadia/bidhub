										...
										<tr>
											<td valign="top" id="body_content" style="background-color: #ffffff;">
												...
												<table border="0" cellpadding="20" cellspacing="0" width="100%" style="font-family:raleway; font-size:20px;">
													<tr>
														<td style="text-align:center;font-weight: regular;color:#000;font-family:raleway;">Review resume for: <span style="color:black;font-weight: bold;">"{{ $resume->help->title }}"</span></td>
                                                    </tr>  
                                                </table>
												<table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_body" style="font-family:raleway; font-size:20px; margin-left:30px;margin-top:35px;">
                                                    <tr>
														...
														<td style="padding-left: 8px; width:1px;"><img src="{{ asset('') . $resume->user->avatar }}" width="60" height="60" alt="No User Picture" style="border: 1px solid #edf1f5;"></td>
                                                        <td style="padding-left: 8px; text-align:left;font-weight: bold;color:#000;font-family:raleway;" valign="top">{{ $resume->profile->first_name }} {{ $resume->profile->last_name }}<br><span style="padding-top:10px">{{ $resume->profile->company }}</span></td>
													</tr>
												</table>
												<table border="0" cellpadding="0" cellspacing="0" width="580" id="template_body" style="font-family:raleway; font-size:20px; margin-top:70px; margin-left:30px;">
                                                    <tr>
														<td style="width:580px;color:#000;font-family:raleway;">Description: {{ $resume->message }}</td>
													</tr>
												</table>
												<table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_body" style="font-family:raleway; font-size:20px; margin-top:20px; margin-left:30px;">
                                                    <tr>
														<td style="width:100%;color:#000;font-family:raleway;">Trade: {{ $resume->profile->trade  }}</td>
													</tr>
												</table>
												<table border="0" cellpadding="0" cellspacing="0" width="182" id="template_body" style="font-family:raleway; font-size:20px; margin:50px 0 30px 30px;">
                                                    <tr>
													    ...
													    <!--[if mso]>
                                                          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ asset('resumes/show') . '/' . $resume->help->id }}" style="height:36px;v-text-anchor:middle;width:150px;" arcsize="5%" strokecolor="#EB7035" fillcolor="#EB7035">
                                                            <w:anchorlock/>
                                                            <center style="color:#ffffff;font-family:raleway;font-size:16px;">View Resume</center>
                                                          </v:roundrect>
                                                        <![endif]-->
                                                        <td><a href="{{ asset('help-wanted/show') . '/' . $resume->help->id }}" style="background-color:#EB7035;border:1px solid #EB7035;border-radius:3px;color:#ffffff;display:inline-block;font-family:raleway;font-size:16px;line-height:44px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;">View Resume</a></td>
													</tr>
												<!-- End Content -->
												</table>
											</td>
