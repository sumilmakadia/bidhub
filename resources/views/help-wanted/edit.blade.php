	...
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor">{{ !empty($help->title) ? $help->title : 'Help' }}</h4>
			</div>
			<div class="col-md-7 align-self-center text-right">
				<div class="d-flex justify-content-end align-items-center">
 <a href="{{ route('help-wanted.help.index') }}" class="btn btn-info m-l-15 float-right" title="{{ trans('helps.show_all') }}">
	 ...
	 Show All Help Wanted
		...
		<div class="row">
            ...
            <form method="POST" action="{{ route('help-wanted.help.update', $help->id) }}" id="edit_help_form" name="edit_help_form" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('help-wanted.form', [
                                        'help' => $help,
                                      ])

                <div class="form-group">
                    <div class="col-md-12">
                        <input class="btn btn-info d-lg-block m-l-15" style="width: 100%;margin-top: 30px;" type="submit" value="{{ trans('helps.update') }}" style="width:100%;">
                    </div>
                </div>
            </form>
            </div>
