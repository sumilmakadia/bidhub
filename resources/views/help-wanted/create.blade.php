	...
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor">{{ trans('helps.create') }}</h4>
			</div>
		...
		<div class="row">
			<div class="col-md-8 mx-auto">
			 ...
			 @if ($errors->any())
                        ...
                        <form method="POST" action="{{ route('help-wanted.help.store') }}" accept-charset="UTF-8" id="create_help_form" name="create_help_form" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
