...
<div class="page-wrapper" style="min-height: 149px;">
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor">{{ !empty($title) ? $title : 'Proposal' }}</h4>
			</div>
 ...
 <a href="{{ route('proposals.proposal.index') }}" class="btn btn-info m-l-15 float-right" title="{{ trans('proposals.show_all') }}">
		...
		<div class="row">
            ...
            <form method="POST" autocomplete="off" action="{{ route('proposals.proposal.update', $proposal->id) }}" id="edit_proposal_form" name="edit_proposal_form" enctype="multipart/form-data" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @include ('proposals.form', [
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-info d-none d-lg-block m-l-15" type="submit" value="{{ trans('proposals.update') }}">
                    </div>
                </div>
            </form>
            </div>
