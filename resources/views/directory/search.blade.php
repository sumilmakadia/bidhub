                                   ...
                                   @php 
                                        ...
                                        <select class="form-control" name="trade[]" id="trade" multiple data-placeholder="Trade">
                                                  ...
                                                  @foreach($trades as $trade)
                                                        <option value="{{$trade->title}}" @if(isset($request)) @if(is_array ($request->trade)) @if(in_array(trim($trade->title), $request->trade)) selected @endif @endif @endif>{{$trade->title}}</option>
                                                  @endforeach
                                        </select>
                              </div>
