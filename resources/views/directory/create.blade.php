		...
		<div class="row page-titles">
			...
			<div class="col-md-7 align-self-center text-right">
				<div class="d-flex justify-content-end align-items-center">
				  <a href="{{ route('directory.free-directories.admin') }}" class="btn btn-info m-l-15 float-right" title="{{ trans('directory.free-directories.admin') }}">
		...
		<div class="row">
			<div class="col-8 mx-auto">
			 ...
			 @if ($errors->any())
                        ...
                        <form method="POST" action="{{ route('directory.directories.store') }}" accept-charset="UTF-8" id="create_directories_form" name="create_directories_form" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @include ('directory.form', [
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-10">
                                    <input class="btn btn-info d-none d-lg-block m-l-15" type="submit" value="{{ trans('directories.add') }}">
                                </div>
                            </div>
