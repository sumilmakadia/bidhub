	...
	Route::get('/help-wanted/show/{help}', 'Crest\HelpsController@show')->name('help-wanted.help.show');
		  ...
		  Route::group(['middleware' => ['auth', 'profile']], function(){
					...
					Route::group([
							  ...
							  Route::get('/', 'Crest\PropertiesController@public')
								   ->name('property-for-sale.property.public');
							  ...
							  Route::get('/show/{property}', 'Crest\PropertiesController@show')
								   ->name('property-for-sale.property.show')->where('id', '[0-9]+');
							  ...
							  Route::post('/search', 'SearchController@property')
								   ->name('property-for-sale.property.search');
					...
					Route::group([
							  ...
							  Route::get('/', 'Crest\ProjectsController@public')
								   ->name('project-room.project.public');
							  Route::get('/manage', 'Crest\ProjectsController@index')
