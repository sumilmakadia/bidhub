		  ...
		  $id = DB::table('properties')->insertGetId([
            ...
            if(empty($id)){ }else{
                ...
                if(count($queryarray) > 0){
            	    ...
            	    $message = 'New Property <strong>'.$request->property_title.'</strong> is created for sale. Please <a href="'.url('show/'.$id).'" target="_blank">click here</a> to view this property.';
            	    mail($setmailids, 'New Property for sale created', $message, $headers);
