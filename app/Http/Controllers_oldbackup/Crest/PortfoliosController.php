...
class PortfoliosController extends Controller
{
    ...
    protected function getData(Request $request)
    {
     ...
     public function removeFile_Profile(Request $request){
         
      
					    
					    $id = $request->id;
					    $file = portfolios_profile_photo::where('id', $id)->first();
					    $file->delete();
					    if($file->file_type != 'pdf'){
					        /*$path = public_path() . "/storage/portfolios/images/" . $file->file_name;*/
